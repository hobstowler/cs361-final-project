...
export default function Home() {
    return (
        <div className='middle'>
            ...
            <p>Or, if you'd like to get started researching something new, search for a stock by symbol with the search
                bar and you can add it to your portfolio and/or watch list from the detailed view page.</p>
